...
""")
    int countByProyectoIdAndEstado(@Param("proyectoId") Long proyectoId, @Param("estadoProyecto") EstadoArchivo estadoProyecto);
    ...
    @Query("""
        ...
        ORDER BY f.nroVersion DESC
    """)
    List<FormatoA> findUltimoFormatoAObservado(@Param("proyectoId") Long proyectoId, @Param("estadoProyecto") EstadoArchivo estadoProyecto, Pageable pageable);
    ...
    """)
    void actualizarFormatoA(@Param("proyectoId") Long proyectoId, @Param("estadoProyecto") EstadoArchivo estadoProyecto);
    ...
    boolean existeFormatoAAprobadoPorCorreo(@Param("correo") String correo, @Param("estado") EstadoArchivo estado);
}
