...
import co.edu.unicauca.coordinatorservice.entity.Programa;
...
public class CoordinadorListener {
    ...
    public void recibirCoordinador(CoordinadorDTO dto) {
        ...
        Optional<Coordinador> existingFormato = coordinadorRepository.findByCorreo(dto.getUsuarioDTO().getEmail());
        ...
        coordinador.setCorreo(dto.getUsuarioDTO().getEmail());
